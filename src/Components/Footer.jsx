  ...
  return (
    <footer>
      <div className={styles.footerWrapper}>
        ...
        <div className={`${theme === "light" ? "navbar-light bg-light" : "navbar-dark bg-dark"} ${styles.footer}`}>
          <div className="container">
            <div className={`row`}>
              <div className="col-sm-12 col-lg-6">
                {/* //Na linha seguinte deverá ser feito um teste se a aplicação
                // está em dark mode e deverá utilizar o css correto */}
                <img className={`${styles.dhLogo} ${theme === "light" ? "" : styles.iconsDark}`} src="/images/DH.png" alt='DH-logo' />
              </div>
              <div className={`col-sm-12 col-lg-6 ${styles.icons} ${theme === "light" ? "" : styles.iconsDark}`}>
